...
ecE.icon = "__Mobile_Factory-Erya__/graphics/Erya/EryaCollectorI.png"
ecE.icon_size = 256
...
ecE.animation =
{
    layers =
    {
        {
        frame_count = 60,
        filename = "__Mobile_Factory-Erya__/graphics/Erya/EryaCollectorE.png",
        size = 600,
        line_length = 10,
        animation_speed = 0.5,
        scale = 0.35
        },
        {
            ...
            line_length = 1,
            repeat_count = 60,
            filename = "__Mobile_Factory-Erya__/graphics/Erya/EryaCollectorS.png",
            size = 600,
            scale = 0.35,
            shift = {0.3, 0.2},
            draw_as_shadow = true
