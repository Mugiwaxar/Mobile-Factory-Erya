...
esI.type = "tool"
esI.name = "EryaSample"
esI.icon = "__Mobile_Factory-Erya__/graphics/Erya/EryaSample.png"
esI.icon_size = 256
...
eplI.type = "item"
eplI.name = "EryaPlate"
eplI.icon = "__Mobile_Factory-Erya__/graphics/Erya/EryaPlate.png"
eplI.icon_size = 256
...
ewI.type = "item"
ewI.name = "EryaWire"
ewI.icon = "__Mobile_Factory-Erya__/graphics/Erya/EryaWire.png"
ewI.icon_size = 64
...
ecI.icon = "__Mobile_Factory-Erya__/graphics/Erya/EryaCircuit.png"
ecI.icon_size = 64
...
emf1I.icon = "__Mobile_Factory-Erya__/graphics/Erya/EryaMachineFrame1.png"
emf1I.icon_size = 256
...
eT.name = "Erya"
eT.type = "technology"
eT.icon = "__Mobile_Factory-Erya__/graphics/Erya/EryaPowder.png"
eT.icon_size = 256
eT.unit = {
	count=300,
	time=2,
